    ...
    <main className="bg-slate-50 dark:bg-gray-800 font-inter">
      {success ? (
        ...
        <section className="container mx-auto grid grid-cols-12 font-inter py-20">
          ...
          <div
            className="hidden md:col-span-5 md:flex items-center justify-center py-20 rounded-lg shadow-slate-300 drop-shadow-lg"
            style={{
          ...
          >
            <div className="w-56">
              <h2 className="text-2xl font-bold leading-tight mb-14">
                TAHAPAN LAPORAN
              </h2>
          ...
          <div className="col-span-12 md:col-span-7 flex items-center justify-center">
            <form
              action=""
              className=" md:w-3/4 mx-auto space-y-6"
            ...
            >
              ...
              <div>
                ...
                <div className="relative">
                  <Autosuggest
                    ...
                    theme={{
                      input:
                        "border rounded-lg border-gray-300 px-3 py-2 w-full",
                      suggestionsContainer:
                        "z-10 bg-white border border-gray-200 rounded w-full mt-1",
                ...
                {errorLocation && (
                  <p className="text-red-500 text-sm mt-1">{errorLocation}</p>
                )}
              </div>
              <FormSelect
                id="category"
              ...
              <FormTextarea
                ...
                label="Deskripsi"
                type="text"
                placeholder="Masukkan Deskripsi Sampah"
                disabled={loading}
