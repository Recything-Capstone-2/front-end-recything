...
export default function AuthLayout({children}) {
  return (
    <main className='min-h-screen flex md:flex-row' style={{backgroundImage: `url(${background})`}}>
      ...
      <section className='md:w-3/5 flex justify-center items-center bg-white shadow-2xl shadow-gray-500 md:rounded-s-3xl p-4 md:p-0'>
        {children}
      </section>
    </main>
  )
