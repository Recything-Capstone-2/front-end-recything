      ...
      <AuthLayout>
        <div>
          <div className='text-center space-y-6'>
            ...
            <h1 className='text-4xl font-bold'>Masuk Akun</h1>
            <p className='text-base font-normal'>Selamat datang kembali! Kelola daur ulang Anda dengan mudah.</p>
          </div>
          <div>
          ...
          <p className='text-sm text-center mt-2 text-red-500 font-semibold'>{error}</p>
          <p className='text-sm font-normal text-center mt-6'>Belum punya akun? <Link to="/register" className='text-primary-05'> Buat akun baru </Link></p>
        </div>
      </AuthLayout>
    </main>
  )
