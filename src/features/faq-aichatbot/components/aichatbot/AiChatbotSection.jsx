    ...
    <div className="flex flex-col h-screen w-full p-4 md:p-6 lg:px-10">
      {!isMessageSent && (
        <>
          ...
          <h2 className="text-lg md:text-2xl font-bold mb-6 text-center dark:text-white">
            Halo {userName},<br /> Bagaimana kita bisa membantu hari ini?
          </h2>
          <p className="text-gray-500 dark:text-gray-200 text-center py-4 text-sm md:text-base">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-6">
            <button
              ...
              className="bg-gray-200 dark:bg-gray-600 text-sm px-4 py-2 rounded-lg flex flex-col items-start min-h-[100px] w-full max-w-xs md:w-80 text-left"
            >
              <span className="font-bold mb-2 dark:text-white">
                Laporan Sampah yang Saya Kirim
              </span>
              <span className="text-xs text-gray-600 dark:text-gray-200 mt-2">
      ...
      <div className="flex flex-col items-center mt-auto mb-8">
        <div className="flex items-center gap-2 p-2 bg-gray-100 dark:bg-gray-600 shadow-md rounded-md w-full max-w-md md:max-w-lg mx-auto mb-3">
          <input
            type="text"
            ...
            className="flex-1 p-3 ml-5 outline-none dark:bg-gray-400 border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-white ring-primary-05 text-sm md:text-base"
          />
          <IoMdSend
        ...
        <p className="text-gray-neutral06 dark:text-gray-200 text-xs md:text-sm text-center">
