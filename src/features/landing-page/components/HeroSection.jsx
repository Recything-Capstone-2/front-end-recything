...
const HeroSection = () => {
  return (
    <section
      id="home"
      className="bg-white min-h-screen py-16 px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-12"
    >
      {/* Left Content */}
      <div className="flex flex-col space-y-4 md:w-1/2">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-relaxed lg:leading-relaxed text-gray-900">
