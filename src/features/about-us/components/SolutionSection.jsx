    ...
    <div>
      <section id="about" className="bg-white relative px-24 py-16">
        ...
        <div className="hidden md:flex relative justify-center items-center gap-4 px-4">
          <div className="w-1/4 h-80 relative z-20">
            <img
          ...
          <div className="w-1/4 h-40 relative z-20">
            <img
              ...
              alt="Foto 2"
              className="rounded-lg object-cover h-full w-full translate-y-[70%]"
            />
          </div>
          <div className="w-1/4 h-80 relative z-20">
            <img
        ...
        {/* Description */}
        <div className="relative bg-primary-05 text-white text-center py-14 px-6 md:px-44 mt-20 z-10">
