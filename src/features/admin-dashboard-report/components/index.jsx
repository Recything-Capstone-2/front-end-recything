    ...
    <div>
      <DashboardAdminLayout header="Semua Laporan">
        <div className="relative max-w-[1440px] overflow-x-auto rounded-lg py-10 px-24 bg-green-50">
          <table className="w-full table-fixed text-sm text-left text-gray-500 border-collapse rounded-lg">
            ...
            <tbody>
              <tr className="odd:bg-white even:bg-primary-01 rounded-lg">
                ...
                <td className="px-6 py-4 space-y-3">
                  <button className="px-2 inline-flex text-xs leading-5 font-semibold rounded-ms bg-slate-200 text-grey-800">
                    Diterima
                  </button>
                  <button className="px-2 inline-flex text-xs leading-5 font-semibold rounded-ms bg-yellow-100 text-yellow-800">
                    Diproses
                  </button>
                  <button className="px-2 inline-flex text-xs leading-5 font-semibold rounded-ms bg-green-100 text-green-800">
                    Selesai
                  </button>
                  <button className="px-2 inline-flex text-xs leading-5 font-semibold rounded-ms bg-red-100 text-red-800">
                    Ditolak
                  </button>
                </td>
                <td className="px-6 py-4">
